  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-16">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden bg-gray-50">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-nba-orange/10 rounded-full blur-[128px]" />
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {['Lakers', 'Bulls', 'Heat', 'Warriors', 'Celtics', 'Nets', 'Knicks', 'Suns'].map((team) => (
                <span
                  key={team}
                  className="px-4 py-2 bg-nba-orange/10 border border-nba-orange/30 rounded-full text-nba-orange text-sm font-medium"
                >
                  {team}
                </span>
              ))}
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="bg-nba-orange/5 rounded-2xl p-8 md:p-12 border border-nba-orange/20">
