...
const discountTiers = [
  { min: 6, max: 11, discount: 10, color: 'bg-green-500' },
  { min: 12, max: 23, discount: 15, color: 'bg-blue-500' },
  { min: 24, max: null, discount: 20, color: 'bg-purple-500' },
];
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-16">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden bg-gray-50">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-amber-500/10 rounded-full blur-[128px]" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <a
              href="#formulario"
              className="inline-flex items-center gap-2 px-8 py-4 bg-black text-white rounded-full font-bold text-lg hover:bg-gray-800 transition-colors"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {discountTiers.map((tier, index) => (
              ...
              >
                <div className="bg-white rounded-2xl p-8 text-center border border-gray-200 hover:border-gray-400 transition-colors">
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full ${tier.color} mb-4`}>
                  ...
                  <p className={`text-5xl font-black mb-2 ${
                    tier.discount === 10 ? 'text-green-500' :
                    tier.discount === 15 ? 'text-blue-500' : 'text-purple-500'
                  }`}>
                    {tier.discount}%
                  </p>
                  <p className="text-gray-400">de descuento</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-white rounded-xl p-6 border border-gray-200 hover:border-gray-400 transition-all"
              >
            ...
            {[
              ...
              >
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <CheckCircle key={i} size={16} className="text-amber-500" />
                  ))}
                </div>
      ...
      {/* Contact form */}
      <section id="formulario" className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            >
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-gray-500 text-sm mb-2">Tu nombre</label>
                  <input
                    type="text"
                    required
                    value={formData.nombre}
                    onChange={(e) => setFormData({ ...formData, nombre: e.target.value })}
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:border-black focus:outline-none"
                    placeholder="Juan Pérez"
                  />
                </div>
                <div>
                  <label className="block text-gray-500 text-sm mb-2">Nombre del negocio</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-gray-500 text-sm mb-2">Teléfono / WhatsApp</label>
                  <input
                    type="tel"
                    required
                ...
                <div>
                  <label className="block text-gray-500 text-sm mb-2">Ciudad</label>
                  <input
                    type="text"
                    required
              ...
              <div className="mb-6">
                <label className="block text-gray-500 text-sm mb-2">Mensaje (opcional)</label>
                <textarea
                  value={formData.mensaje}
                  onChange={(e) => setFormData({ ...formData, mensaje: e.target.value })}
                  rows={4}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:border-black focus:outline-none resize-none"
