  ...
  return (
    <div className="min-h-screen bg-black pt-32 pb-16">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-mlb-blue/30 via-black to-mlb-blue/10" />
        <div className="absolute top-0 right-0 w-96 h-96 bg-mlb-blue/20 rounded-full blur-[128px]" />
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {['Yankees', 'Dodgers', 'Red Sox', 'Cubs', 'Giants', 'Braves', 'Marlins', 'Rangers'].map((team) => (
                <span
                  key={team}
                  className="px-4 py-2 bg-mlb-blue/20 border border-mlb-blue/40 rounded-full text-white/80 text-sm"
                >
                  {team}
                </span>
              ))}
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="bg-gradient-to-r from-mlb-blue/20 to-mlb-blue/5 rounded-2xl p-8 md:p-12 border border-mlb-blue/20">
